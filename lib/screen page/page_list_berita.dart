...
import 'package:uas/model/mode_login.dart';
import 'package:uas/screen%20page/page_login_api.dart';
import 'package:uas/utlis/cek_session.dart';
  ...
  Future<List<Datum>?> getBerita() async {
    try {
      ...
      http.Response response = await http.get(
        Uri.parse("http://192.168.43.243/uas_mobile/berita.php"),
      );
                              ...
                              children: [
                                Padding(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network('http://192.168.43.243/uas_mobile/image/${data.gambar}',
                                        fit: BoxFit.fill,
                                      ),
                                    )
                                ),
